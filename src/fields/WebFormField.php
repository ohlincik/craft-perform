...
use tungsten\webform\assetbundles\webformfieldfield\WebFormFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class WebFormField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('webform', 'WebFormField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'webform/_components/fields/WebFormField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(WebFormFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').WebFormWebFormField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'webform/_components/fields/WebFormField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
